...
import { refreshTmdbListMovie } from '../modules/movies/movie.service.js';
import { mapTmdbMovieToPrisma } from '../utils/tmdbMapper.js';
...
const syncFullMovieBatch = async (movies) => {
    for (const movie of movies) {
        ...
        const { slug, createdById, ...movieData } = mapTmdbMovieToPrisma(response.data);
