...
export const personDetail = asyncController(async (req, res) => {
...
export const similarMovies = asyncController(async (req, res) => {
...
export const topRatedMovies = asyncController(async (req, res) => {
...
export const trendingNepaliMovies = asyncController(async (req, res) => {
    const movies = await getTrendingNepaliMovies();
